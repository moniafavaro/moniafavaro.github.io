...
const Contact = () => {
  ...
  return (
    <Card id="contact" className="border-0">
      <Card className="text-center border-0">
        ...
        <Container>
          <Card.Body className="interest-para mb-5">
            ...
            <div className="interest-icon">
              <img src={Travelling} alt="travel-icon" className="travel-icon" />
              <p>
                Visiting other countries and immersing myself in their culture
                is one of my passions. I have previous adored my experiences in
                Italy, Portugal and Denmark, and my next trips will be to:
